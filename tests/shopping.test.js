...
test('shopping list groups scaled ingredients by practical category', () => {
  ...
  assert.ok(countShoppingItems(groups) >= recipe.ingredients.length);
});

test('shopping list includes recipe-specific consumables', () => {
